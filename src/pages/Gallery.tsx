  ...
  useEffect(() => {
    ...
    if (savedPhotos) {
      ...
      const defaultPhotos: Photo[] = [
        ...
        {
          id: '2',
          url: 'https://images.pexels.com/photos/1729797/pexels-photo-1729797.jpeg?auto=compress&cs=tinysrgb&w=600',
          caption: 'Celebrating with Friends',
          uploadDate: new Date().toISOString()
        }
      ];
      setPhotos(defaultPhotos);
      localStorage.setItem('birthday-photos', JSON.stringify(defaultPhotos));
    }
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-purple-700 mb-8">
            ini gamabar kmu sama teman kmu
          </p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-3xl p-8 max-w-md w-full">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-purple-800">Add New Photo</h3>
                <button
